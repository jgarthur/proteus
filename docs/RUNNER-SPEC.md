...
**Targets**: Proteus v0.2.1 engine, API metrics schema v0.2.4.
...
Metrics retain the API v0.2.4 distinction:
...
`metrics` is the API v0.2.4 `MetricsSnapshot` object verbatim, including every
...
| `final_metrics` | Complete API v0.2.4 `MetricsSnapshot` at `final_tick` |
