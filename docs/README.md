...
- `RUNNER-SPEC.md` - Implemented MVP contract for deterministic single-run and fixed-batch headless execution, including strict manifests, outputs, supervision, and resume semantics.
