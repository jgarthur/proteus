...
- [ ] RAYON-HOTSPOTS: Remaining performance tiers after the sampler work (SoA hot-field split, Pass 1 dispatch); roadmap in `docs/analysis/2026-08-13_performance-roadmap.md`. Tier 2b (inline program storage) was built, reviewed, and shelved as a measured regression at every cap — see `docs/analysis/2026-08-22_inline-program-storage-results.md`.
