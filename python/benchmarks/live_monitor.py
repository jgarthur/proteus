...
def _print_point(point: dict[str, Any], *, elapsed_seconds: float, interval_seconds: float, interval_tps: float) -> None:
    print(
        ...
        f"{point['replicator_motif_share']:.3f}".rjust(8),
        f"{point['boot_nontrivial_survivor_share_10']:.3f}".rjust(8),
        f"{point['boot_fragment_survivor_share_10']:.3f}".rjust(8),
        f"{point['absorb_only_share']:.3f}".rjust(8),
        f"{point['absorb_dominated_share']:.3f}".rjust(8),
        f"{point['move_success_rate']:.3f}".rjust(8),
